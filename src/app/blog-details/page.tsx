...
const BlogDetailsPage = () => {
  ...
  useEffect(() => {
    const data = blogData.filter(item => item.id === Number(id))
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="mb-1 text-base font-medium text-body-color">
                          By <span>{singleBlog?.author?.name}</span>
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  {singleBlog?.items?.map((item : any, index) => (
                    <p 
                      key={index}
                      className="mb-10 text-base font-medium leading-relaxed text-body-color 
