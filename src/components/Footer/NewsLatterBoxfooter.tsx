...
//   return (
//     <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-8">
//       <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
//         Subscribe for Updates
//       </h3>
//       <p className="mb-6 text-sm leading-relaxed text-body-color dark:text-body-color-dark">
//         Ensuring you stay ahead with the latest insights, trends, and exclusive
...
//           type="submit"
//           value="Subscribe"
//           className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-lg bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/60 dark:shadow-submit-dark"
//         />
