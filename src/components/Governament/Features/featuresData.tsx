...
const featuresData: Feature[] = [
  {
    ...
    features: [
      ...
      'Track Your Application: Stay updated with real-time notifications on the status of your permit request.',
      'Secure Online Payments: Complete your applications swiftly with our secure, integrated online payment system.'
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    title: "Comprehensive Management at Your Fingertips (For County Staff)",
    ...
    features: [
      'Intuitive Dashboard: Manage all permit requests through a user-friendly interface that provides a clear overview of pending, approved, and completed applications.',
      'Efficient Processing: Our system simplifies the review and approval process, ensuring that permit requests are handled swiftly and effectively.',
      'Document Management: Easily access, review, and store all necessary documents and forms associated with each permit application.',
      'Reporting and Analytics: Gain valuable insights into permit trends, processing times, and staff performance with our advanced analytics tools.'
    ]
  }
]
