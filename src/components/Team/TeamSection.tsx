    ...
    <section className="">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          ...
          <p className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">We focus on markets where technology, innovation, and capital can unlock long-term value.</p>
        </div>
        <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-1">
          {TeamData.map((item, index) => (
            <div key={index} className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <img className="w-96 rounded-lg sm:rounded-none sm:rounded-l-lg" src={item.image} alt="Bonnie Avatar" />
              <div className="p-5">
